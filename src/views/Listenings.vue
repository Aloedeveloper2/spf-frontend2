<template>
    ...
    >
        ...
        <template v-slot:top>
            <v-toolbar flat>
                ...
                <v-dialog v-model="dialogDelete" max-width="500px">
                    <v-card>
                        <v-card-title class="text-h5"
                            >Veuillez-confirmer votre opération</v-card-title
                        >
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn
                ...
                <v-dialog v-model="dialogUpload" max-width="500px">
                    <v-card>
                        <v-card-title> Insérez le fichier audio </v-card-title>
                        <v-card-text>
                            <v-file-input
                                label="Fichier audio"
                                outlined
        ...
        <template v-slot:[`item.actions`]="{ item }">
            <v-icon class="mr-2" @click="getListeningId(item)"> mdi-book-music </v-icon>
